...
- `orchestrator/`: browser-side orchestration graph model helpers for versioned graph constants, graph metadata, node defaults, node categories, edge typing, and edge normalization
...
- `orchestrator/` owns the browser-side orchestration graph model helpers; see `app/L0/_all/mod/_core/orchestrator/AGENTS.md`
