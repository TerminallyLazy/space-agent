...
- `orchestrator_model_test.mjs`: focused browser-model coverage for `_core/orchestrator` graph and node schema constants, node default normalization, node category rules, edge type derivation, edge normalization, and semantic edge colors
